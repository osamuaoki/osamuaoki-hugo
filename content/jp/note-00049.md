...
2022年1月以前のKiCad情報はV5以前を使っているので、現行のV6のDocumentation/Tutorialから読むのが良さそうです。
...
* [Keyboard Layouter Plugin](https://github.com/yskoht/keyboard-layouter) -- KiCad plugin　ツール
  * [1行もコードを書かずに自作キーボードを作る](https://zenn.dev/0x0c/articles/4e4e428d79287d4556b2) -- 記事
