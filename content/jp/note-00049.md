...
[ただ新しいLEDは動くらしい。](https://www.reddit.com/r/arduino/comments/cue3e8/ws2812b_on_33v_data_level_shifter_or_not/)
[WS2812b Data-line 3.3v or 5v??](https://www.reddit.com/r/FastLED/comments/gku4j7/ws2812b_dataline_33v_or_5v/)をでもはっきりしていない。

一度、「実際のRGB LED デバイスの許容はどのくらいなのか？」は、手持ちの古いWS2812Bや、キーボード用のSK6812のSMDデバイスで実験で確認しておきたい。さらに、電源ノイズの影響を押さえるパスコンの必要性も確認かな?
...
* 他の対応方法: Drive open drain MOS-FET with inverted output logic

実験にはIOT用の他のプラットフォームが使えそう。
