...
WS2812関連の少し古いAVR系にフォーカスした基本情報:

* https://github.com/cpldcpu/light_ws2812/ 871 stars AVR コード (BITBANG)
* 連載記事
...
タイミングや駆動電圧に関する実状が調査されている。

STM32を意識したライブラリー情報:

* https://sites.google.com/site/hubmartin/arm/improved-stm32-ws2812b-library 記事
  * ソースコード
    * https://github.com/hubmartin/WS2812B_STM32F103 39 stars
    * https://github.com/hubmartin/WS2812B_STM32F3 54 stars
    * https://github.com/hubmartin/WS2812B_STM32F4 77 stars
* https://www.newinnovations.nl/post/controlling-ws2812-and-ws2812b-using-only-stm32-spi/ SPI and DMA (STM32)

ARM系だと、BITBANGより効率的なSPI利用でプログラムできるが、さらにDMAを組み合わすとより効率的になる模様だ。
