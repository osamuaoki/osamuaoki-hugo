...
$ cd .build
$ dfuse-pack -i cgg56_default.hex cgg56_default.dfu
$ dfu-util -d 0483:df11 -a 0  -D cgg56_default.dfu 
dfu-util 0.11
...
Parsing DFU image 1
Target name: ST...
Image for alternate setting 0, (2 elements, total size = 33564)
Setting Alternate Interface #0 ...
Parsing element 1, address = 0x08000000, size = 480
Erase   	[=========================] 100%          480 bytes
Erase    done.
Download	[=========================] 100%          480 bytes
Download done.
Parsing element 2, address = 0x08008000, size = 33068
Erase   	[=========================] 100%        33068 bytes
Erase    done.
Download	[=========================] 100%        33068 bytes
Download done.
Done parsing DfuSe file
$ sudo dfu-util -d 0483:df11 -a 0  -D cgg56_default.dfu
dfu-util 0.11
...
パーミッション問題は無くなったけど、、、動かない

https://blog.ikejima.org/make/keyboard/2021/05/03/blackpill-keyboard.html
https://www.reddit.com/r/olkb/comments/mhrtra/how_to_customize_handwired_layout_in_blackpill_mcu/
https://mechwild.com/guides/build-guides/obe-build-guide/
