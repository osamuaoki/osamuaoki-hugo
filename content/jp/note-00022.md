...
基本のブートローダーは上記3種で、いずれも、2KB-4KBの間です。

* https://github.com/osamuaoki/lufa (上記コメント時、2019年)
* https://github.com/abcminiuser/lufa (2021年にアップデートされている)

## ArduinoのCaterina -- CDC ブートローダー
...
## Sparkfanの改造版Caterina -- CDC ブートローダー
...
TeensyのLEDに対応するものがなかったのでトライしていません。
...
2021年確認: LED機能はUPSTREAMがマージし、どうもさらに改良しています。また、
[sigprof](https://github.com/sigprof/nanoBoot)から興味ある
PRが出ています：
[Configure endpoint 1 to fix USB errors](https://github.com/volium/nanoBoot/pull/13)。

### 付録: `hid_bootloader_cli`
