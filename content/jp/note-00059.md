...
|Position↓|Formal↓ \\ Type→ |Asset|Equity|Expenses|Income|Liabilities|
|:-----:|:---:|:---:|:----:|:------:|:----:|:---------:|
| 位置↓ | 正式名↓ \\ タイプ→ |資産|純資産|費用|収益|負債|
|Left Column|Debit|Increase|Decrease|Expense|Charge|Payment|
|左列|借方|増加|減少|費用|請求|支払|
|Right Column|Credit|Decrease|Increase|Rebate|Income|Charge|
|右列|貸方|減少|増加|値引|収益|請求|
