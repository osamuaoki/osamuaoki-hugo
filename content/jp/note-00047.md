...
キーマップ中の左上文字がFn1~F4の何れも押さない場合、右下文字がFn1かF2のいずれかがが押された場合に入力されます。

30%系のキーマップはとにかくホームからほとんど手が動かないので悪くないです。ただ、片手打ちができないことが多いという面があります。基本的に両手をキーボード上に置いておく必要があります。
...
[KLEで実際にこのcgc56キーボードのmini keymap](http://www.keyboard-layout-editor.com/#/gists/a4cbabebb886c175ff4c99419e462205)で覚えるべきレイヤーをまとめました。
