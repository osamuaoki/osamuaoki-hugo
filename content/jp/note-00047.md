...
片側`6X3_3`キー構成ぐらいのスプリットの小さな携帯タイプのカスタムキーボードが面白そうなので、当分は取り組まないけどPCBを作る際に参考となる情報をまとめました。
...
* [Keebio-Parts.pretty](https://github.com/keebio/Keebio-Parts.pretty) 333
* [keebio-components](https://github.com/keebio/keebio-components) 41
* [tmk: keyboard_parts.pretty](https://github.com/tmk/keyboard_parts.pretty) 135
  * [colemarkham: keyboard_parts.pretty](https://github.com/colemarkham/keyboard_parts.pretty) 42
