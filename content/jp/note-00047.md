...
片側`6x3_3`キー構成のスプリットキーボードだと、ダイオード無しNKROのPCB設計も加能ですが、OLEDや他の拡張がしにくくなります。
...
`TAPPING_TERM`は遅め250に設定しています。

機敏な応答がいらないMODE関連は基本50%増し、小指などの動きが悪いキーは100%増しの`TAPPING_TERM`に設定してます。

意識的にタップするように慣れる必要があります。最初はなぜキーが入力されていないのか悩ましかったです。
