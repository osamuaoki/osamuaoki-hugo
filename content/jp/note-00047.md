...
30%系のキーマップはとにかくホームからほとんど手が動かないので悪くないです。

ただ、片手打ちができないことが多いという面があります。基本的に両手をキーボード上に置き、タップをする際にはキーを意識的に離す必要があります。
...
小指は使いますが、普通のキーボードとの親和性も良いいい感じのキーマップになりました。
...
左右の手の間隔が30cm以下となる一体型キーボードだと手首が外側にくるので、一体型では縦スタガートは使いにくそうです。
