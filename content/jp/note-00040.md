...
Blackpillですが、有名なIOTパーツ販売サイトの[Adafruit(USA)](https://www.adafruit.com/product/4877)が米国東海岸のNYCから売っています。そのオリジナル製造元の[WeActの正規ストアーが日本に近い中国本土出荷のAliexpress](https://weactstudio.aliexpress.com/store/910567080)で定価694円（送料348円）で売っています。まあ、これだと本物のSTMのチップが載ってそうです。STM32F411だとDFUはROMで入っているし、価格性能も魅力です。AliexpressならPaypalなので支払いも安心です。
...
しかし安いボードはMCUまで違うと知り驚いてます。AliExpress は便利なんだけど、贋物、コンパチもの状況が気になるので、関連情報のリンクをリストしておきます。
