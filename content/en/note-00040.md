...
Since nvim may not available, I created locale shell executable `~/bin/vi` as:
...
Here, I created simple generic `~/.vimin` as:

```
" Simple generic Vim/Neovim configuration
" SYNTAX: (n)vim -u ~/.vimin [filenme]
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""" sane mode
set nocompatible
...
""" Unicode display
set laststatus=2
set statusline=%<%f%m%r%h%w%=%y[U+%04B]%2l/%2L=%P,%2c%V " Unicode display
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
nnoremap <C-L> <C-W>l
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""" jk to get out of INSERT mode (<ESC>)
inoremap  jk        <ESC>
" <ESC> <ESC> to get out of TERM mode (CTRL-\ CTRL-N)
...
I also created bash aliases in `~/.bashrc` as:
...
alias v='nvim  -u NORC'
# `nv` as neovim with standard resources (currently LazyVim)
alias nv='nvim'
