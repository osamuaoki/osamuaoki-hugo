...
I made following extra features disabled as started and can be enabled via key
bindings..
...
I also made `<leader>uu` as NOP.

### Unicode codepoint in statusline

I replaced useless clock display in status line with unicode codepoint such as `[+U0044]`.
