...
Saving [template with configuration](https://help.libreoffice.org/latest/en-US/text/shared/guide/standard_template.html)
seems to be a trick to make these changes persistent.

[Pre-template default font settings across all applications seem to be accessible](https://ask.libreoffice.org/t/how-do-you-set-the-default-font-in-libreoffice-calc-v6-2/52814/8).  Under 7.4, the same can be done as:
...
TBH, this "Advanced" tricks are too complicated to be edited wisely for me.  So
I decided to keep myself away from these.
