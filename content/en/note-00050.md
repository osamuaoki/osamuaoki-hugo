...
+-------------+---------+----------------------+---------------------------------------------+-----------+-----------+
```
Let me inspect instances again after stopping them
```
$ lxc stop debian-12
...
Let me turn-on again and quickly inspect twice.
...
This change is because of slow network activation.

Let me turn-off IPV6 connection service for LXD.  One need to restart it to
...
I think I got some glimpses of LXC/LXD now.
...
I searched available GUI UIs but no luck ...:
