...
As I checked the Debian image, I realize that it is a minimalistic one and
doesn't include `cloud-init` nor `netplan.io` packages.

### More operations on instances

I followed more in "[First steps with LXD](https://documentation.ubuntu.com/lxd/en/latest/tutorial/first_steps/)" and "[Instances](https://documentation.ubuntu.com/lxd/en/latest/instances/)" to see following commands in action.
...
I searched available GUI UIs but ...:
