...
process ~/salsa
process ~/tmp
# gather files to "rsync"
gather ~/rsync
# make new copy from "rsync" to remote site
copy ~/rsync
# prune redundant snapshots
process ~/rsync
```
...
```sh
 $ bss batch
SH: export BSS_TYPE=hour
N: Make snapshot (user mode): BASE=/home/osamu TIME=2023-12-30T13:06:00+00:00 TYPE=hour
N: Make snapshot (user mode): BASE=/home/osamu/Documents TIME=2023-12-30T13:06:00+00:00 TYPE=hour
N: Make snapshot (user mode): BASE=/home/osamu/github TIME=2023-12-30T13:06:01+00:00 TYPE=hour
N: Make snapshot (user mode): BASE=/home/osamu/salsa TIME=2023-12-30T13:06:01+00:00 TYPE=hour
N: Make snapshot (user mode): BASE=/home/osamu/tmp TIME=2023-12-30T13:06:01+00:00 TYPE=hour
```
-->
