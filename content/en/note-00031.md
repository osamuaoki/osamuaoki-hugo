...
Let me record how I looked into the internals of AstroNvim. 

### Prerequisite

See [Getting started using Lua in Neovim](https://github.com/nanotee/nvim-lua-guide) and its linked documents first.
...
Here, it is impossible to read so much output and make any sense.  Here,
`:redir` can be used to ease reading of these by capturing output in a file.
(The use of `:sirent` kills pager prompt.)
...
Here, we need to look into 3 functions:
