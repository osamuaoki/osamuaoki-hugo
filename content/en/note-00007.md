...
**This is not used any more** -> map Caps to Esc by GNOME tweaks
...
### ~~Indentation changes in VISUAL MODE~~

**This is not used any more**  (Type "." if you need.)

Remap to keep VISUAL MODE selection for `<` and `>`.
...
Let's set cursorline in NORMAL MODE (and starting)
