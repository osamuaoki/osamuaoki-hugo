...
at https://github.com/osamuaoki/dot-vim .  This is not general purpose plugin
managing system but if you are manually managing Vim plugins with Vim 8's
native package management infrastructure, and `git submodule`, this may give
you interesting hints.
...
Then you access and use the jump listi from COMMAND MODE.
