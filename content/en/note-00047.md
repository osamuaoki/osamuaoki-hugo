...
https://extensions.gnome.org/review/42621
```
Very kind words on careless newbie.  I fixed and uploaded.
...
on JavaScript except it is a interpreter with C/C\+\+-like syntax. Here are
list of documents I decided to read following references to understand
JavaScript and its use for GNOME.
