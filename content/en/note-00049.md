...
### Non-usable Keyboard shortcut key combos for super
...
## XXXXXXXXXXXXX EXTRAS XXXXXXXXXXXXXXXXXXXX
...
* Execute `apt-get update && apt-get install aptitude sudo vim mc wget git nano-`
...
For network connections, the Network Manager is enabled for all interfaces by
commenting out "The primary network interface" section in
