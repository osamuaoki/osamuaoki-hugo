 ...
 * [Thinkpad T14]({{<ref "note-00010.md" >}})
 * [Sony Vaio SVT1313]({{<ref "note-00035.md" >}}#install-to-sony-vaio-svt1313-2013-model)
...
For `sudo`, you need to set account membership for each account.

GDM seems to get confused by this situation.  Please login using explicitly
using account name.
