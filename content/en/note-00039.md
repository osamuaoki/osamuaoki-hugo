...
I used the previous Debian package's `debian/rules` as my guide to set
parameters.

Here is a script to build a Neovim Debian package from the
[current Neovim upstream git repo](https://github.com/neovim/neovim):
```
#!/bin/sh
...
I also used following interesting references.
