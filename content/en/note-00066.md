...
Here, files stored under `roles/base/files` are copied to the remote system.
...
setup using jinja template files stored under `roles/base/templates`.
...
can be used logical groups of tasks.

As for running operations on change,
[handler](https://docs.ansible.com/ansible/latest/playbook_guide/playbooks_handlers.html)
can be used.

I think I now grok how Ansible can be used.  So much for talking ....
