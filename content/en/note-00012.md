...
# (1: for dput, 0: not for dgit source source-push)
...
| GIT    | yes       | yes   | 24   |  7m21s  | 35m08s  |12m434  | Hotter CPU |
...
chroot environment which can run x-apps using the schroot directory.
...
To run x-apps isuch as `gitk` inside chroot, please start schroot as:
