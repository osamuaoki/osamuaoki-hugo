...
`/etc/schroot/desktop/`.  (My user name is "osamu" and my hostname is "goofy".)
...
DESCRIPTION
    This helps you to work with persistent pre-loaded (source) chroot
    environment and is modeled after *sbuild-shell* and *sbuild-update*
    but uses an independent chroot which is not used by sbuild.

    This uses schroot profile 'desktop'.  You must customize this
    profile at '/etc/schroot/desktop/fstab' to list all mounted
    devices in your home directory.  The actual profile used can be
    changed by setting the '${SCHROOT_PROFILE}' environment variable.
    ...
    terminal with access to the data in your home directory.
    ...
    DIST can be 'unstable', 'testing', 'stable', 'oldstable', or
    'oldoldstable'; and can be shortened as 'u', 't', 's', 'o', or 'oo'.
    ...
    environment for this command and optionally for sbuild.
      ...
      * '/srv/chroot/${DIST}-amd64-desktop' used by this program to
    ...
    terminal operations to '/srv/chroot/${DIST}-amd64-desktop'

    If '--upgrade' or '-u' is given as an option, this updates schroot
    environment of '/srv/chroot/${DIST}-amd64-desktop'
