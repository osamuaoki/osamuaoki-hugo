...
DESCRIPTION
    ...
    environment for this command and optionally for sbuild.
      ...
      * '/srv/chroot/${DIST}-amd64-term' used by this program to start
        the terminal shell prompt as a source chroot of a loaded system
    ...
    to be created.  Currently '/etc/schroot/osamu/*' profile
...
`/etc/schroot/osamu/fstab` based on `/etc/schroot/desktop/fstab`
