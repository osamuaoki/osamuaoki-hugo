...
* For package build, I decided to move to `sbuild`.
...
You may need to run my script I posted there to work around problem.
...
You may wish to copy setting from host PC for sudo, ...

### Build environment customization

You can login to the baseline chroot environment to customize it as:
