...
Shortcut SUPER-O
```
(`SUPER-O` is easier to type than `SUPER-T`.  I also created `SUPER-\\` )
...
[Unsafe Mode Menu](https://github.com/linushdot/unsafe-mode-menu) extension and enable it to get the above command to work as expected.
