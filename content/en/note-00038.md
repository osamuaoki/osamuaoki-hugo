...
Following deprecated method yields not-as-good user experience (release of left
click happens when right click is desired first).
...
* `bu`: local `~/bin/` script to backup data to USB drive.  See [Backup and snapshot]({{< ref "note-00028.md" >}}).
