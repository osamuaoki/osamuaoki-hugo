---
title: "Debian Workstation (Bookworm) (v2023-02)"
date: 2023-02-25
categories:
  - desktop
  - english
...
This is an deprecated guide.  See the [newer updated guide]({{< ref note-00049.md>}}).
...
* Add [configuration file for personal DEB package repository]({{< ref "note-00033.md" >}}#setting-up-secure-apt-cliant).
...
* Main `vi` editor: `nvim` with `~/.config/nvim`
  ...
  * Configuration by [forked LazyVim starter](https://github.com/osamuaoki/starter) in `~.config/nvim`.  See [Re-learning Vim (7)]({{< ref "note-00040.md" >}}).
