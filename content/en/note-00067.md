...
But, we can't use such "extra vars" variable names casually within the play and
...
reasonable alternative.  Then we can handle default values for the undefined
cases and variable type issues can be handled gracefully.

I put such variable name conversion code in the low priority "role default".
It also takes care variable type issues.
