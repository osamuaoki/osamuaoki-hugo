...
* I ended up selecting "legacy" mode to use MBR.
...
Touch pad only functions as left-click button.  Since I only see one button
switch, left/right click needs some driver support.  So far under Wayland, I am
    not successful to configure properly.  Interesting references are:
...
"Click assist" seems to be useful to emulate right-click.
