...
Microsoft Windows® USB installation media preparer for GNU+Linux
...
If the UEFI available on your system supports NTFS or you use
[UEFI:NTFS](https://github.com/pbatard/uefi-ntfs), you can boot Windows by
copying the original `sources/install.wim` into  NTDF without splitting it.

You may also make this to Legacy/UEFI hybrid boot disk.
