...
[Debian Workstation (usability) (old)) -- Keyboard shortcut customization (GNOME Settings)]({{<ref note-00011.md>}}#keyboard-shortcut-customization-gnome-settings) stopped working for me.   This is how I came to update my memo to [Debian Workstation (usability) (v2023) -- Keyboard shortcut customization (GNOME Settings – custom shortcut)]({{<ref note-00038.md>}}#keyboard-shortcut-customization-gnome-settings----custom-shortcut).
